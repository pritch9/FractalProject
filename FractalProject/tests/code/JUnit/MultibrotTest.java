...
public class MultibrotTest {
	...
	public void testXCoordinates(){
		...
		assertEquals(0, _multi.getCol(-1.0f));
		assertEquals(256, _multi.getCol(0.0f));
		assertEquals(511, _multi.getCol(1.0f));
	}
	...
	public void testYCoordinates(){
		...
		assertEquals(0, _multi.getRow(-1.3f));
		assertEquals(256, _multi.getRow(0.0f));
		assertEquals(511, _multi.getRow(1.3000f));
	}
	
	@Test
	public void testMaxEscapes(){
		assertEquals(_max, _points[_multi.getCol(0.5859375f)][_multi.getRow(0.24375000000000108f)]);
	}
	
	@Test
	public void testSingleEscapes(){
		assertEquals(1, _points[_multi.getCol(0.9921875f)][_multi.getRow(1.05625f)]);
	}
